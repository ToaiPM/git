...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('public/img/icon/favicon.png')}}">
    ...
    <link rel="stylesheet" href="{{asset('public/css/style-customizer.css')}}">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6 hidden-xs">
                            <div class="call-us">
                                <p class="mb-0 roboto">(+84) 0985956340</p>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xs-12">
                            <div class="top-link clearfix">
                                <ul class="link f-right">
                                    ...
                                    @else
                                    <li>
                                        <a href="{!! route('getDangNhapDangKy') !!}">
                                            <i class="zmdi zmdi-lock"></i>
                                            Login
                                        </a>
                                    </li>
                    ...
                    <div class="full-width-mega-dropdown">
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-6 col-xs-12">
                                <div class="logo">
                                    <a href=".">
                                        <img src="{{asset('public/img/logo/logo.png')}}" alt="main logo">
                                    </a>
                                </div>
                            </div>
                            <!-- primary-menu -->
                                        ...
                                        <li class="mega-parent"><a href="shop.html">Products</a>
                                            <div class="mega-menu-area clearfix">
                                                ...
                                                <div class="mega-menu-photo f-left">
                                                    <a href="#">
                                                        <img src="{{asset('public/img/mega-menu/1.jpg')}}" alt="mega menu image">
                                                    </a>
                                                </div>
                                            </div>
                                        </li>
                                                    ...
                                                    <div class="total-cart-pro">
                                                        ...
                                                        <div class="single-cart clearfix">
                                                            <div class="cart-img f-left">
                                                                <a href="#">
                                                                    <img src="{{asset('public/img/cart/1.jpg')}}" alt="Cart Product" />
                                                                </a>
                                                                <div class="del-icon">
                                                                    <a href="#">
                    ...
                    <div class="row">
                        <div class="active-slider-1 slick-arrow-1 slick-dots-1">
                            ...
                            <div class="col-md-12">
                                <div class="layer-1">
                                    <div class="slider-img">
                                        <img src="{{asset('public/img/slider/slider-1/1.jpg')}}" alt="">
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="layer-1">
                                    <div class="slider-img">
                                        <img src="{{asset('public/img/slider/slider-1/2.jpg')}}" alt="">
                                    </div>
                                    <div class="slider-info gray-bg">
                                        <div class="slider-info-inner">
                                            <h1 class="slider-title-1 text-uppercase text-black-1">WaterProof smartphone</h1>
                        ...
                        <div class="row active-by-brand slick-arrow-2">
                            ...
                            <div class="col-xs-12">
                                <div class="single-brand-product">
                                    <a href="single-product.html"><img src="{{asset('public/img/product/5.jpg')}}" alt=""></a>
                            ...
                            <div class="col-xs-12">
                                <div class="single-brand-product">
                                    <a href="single-product.html"><img src="{{asset('public/img/product/6.jpg')}}" alt=""></a>
                                    <h3 class="brand-title text-gray">
                                        <a href="#">Brand name</a>
                                    </h3>
                                </div>
                            ...
                            <div class="col-xs-12">
                                <div class="single-brand-product">
                                    <a href="single-product.html"><img src="{{asset('public/img/product/7.jpg')}}" alt=""></a>
                                    <h3 class="brand-title text-gray">
                                        <a href="#">Brand name</a>
                                    </h3>
                                </div>
                            ...
                            <div class="col-xs-12">
                                <div class="single-brand-product">
                                    <a href="single-product.html"><img src="{{asset('public/img/product/8.jpg')}}" alt=""></a>
                                    <h3 class="brand-title text-gray">
                                        <a href="#">Brand name</a>
                                    </h3>
                                </div>
                        ...
                        <div class="col-md-8 col-sm-12 col-xs-12">
                            <div class="up-comming-pro gray-bg clearfix">
                                <div class="up-comming-pro-img f-left">
                                    <a href="#">
                                        <img src="{{asset('public/img/up-comming/1.jpg')}}" alt="">
                                    </a>
                                </div>
                        ...
                        <div class="col-md-4 hidden-sm col-xs-12">
                            <div class="banner-item banner-1">
                                ...
                                <div class="banner-img">
                                    <a href="#"><img src="{{asset('public/img/banner/1.jpg')}}" alt=""></a>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-4 col-xs-12">
                                        <div class="product-item">
                                            <div class="product-img">
                                                <a href="single-product.html">
                                                    <img src="{{asset('public/img/product/10.jpg')}}" alt=""/>
                                                </a>
                                            </div>
                                            <div class="product-info">
                                                <h6 class="product-title">
                                    ...
                                    <div class="col-md-3 col-sm-4 col-xs-12">
                                        <div class="product-item">
                                            <div class="product-img">
                                                <a href="single-product.html">
                                                    <img src="{{asset('public/img/product/11.jpg')}}" alt=""/>
                                                </a>
                                            </div>
                                            <div class="product-info">
                                                <h6 class="product-title">
                                    ...
                                    <div class="col-md-3 hidden-sm col-xs-12">
                                        <div class="product-item">
                                            <div class="product-img">
                                                <a href="single-product.html">
                                                    <img src="{{asset('public/img/product/12.jpg')}}" alt=""/>
                                                </a>
                                            </div>
                                            <div class="product-info">
                                                <h6 class="product-title">
                                ...
                                <div class="col-lg-4 col-md-5 col-sm-4">
                                    <div class="single-footer footer-about">
                                        <div class="footer-logo">
                                            <img src="{{asset('public/img/logo/logo.png')}}" alt="">
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <ul class="footer-payment text-right">
                                        <li>
                                            <a href="#"><img src="{{asset('public/img/payment/1.jpg')}}" alt=""></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{asset('public/img/payment/2.jpg')}}" alt=""></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{asset('public/img/payment/3.jpg')}}" alt=""></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{asset('public/img/payment/4.jpg')}}" alt=""></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="modal-product clearfix">
                                <div class="product-images">
                                    <div class="main-image images">
                                        <img alt="" src="{{asset('public/img/product/quickview.jpg')}}">
                                    </div>
                                </div><!-- .product-images -->
        ...
        <div class="style-customizer closed">
            ...
            <div class="clearfix content-chooser">
                ...
                <ul class="patternChange main-bg-change clearfix">
                    <li class="main-bg-1" data-style="main-bg-1" title="Background 1"> <img src="{{asset('public/images/customizer/bodybg/01.jpg')}}" alt=""></li>
                    <li class="main-bg-2" data-style="main-bg-2" title="Background 2"> <img src="{{asset('public/images/customizer/bodybg/02.jpg')}}" alt=""></li>
                    <li class="main-bg-3" data-style="main-bg-3" title="Background 3"> <img src="{{asset('public/images/customizer/bodybg/03.jpg')}}" alt=""></li>
                    <li class="main-bg-4" data-style="main-bg-4" title="Background 4"> <img src="{{asset('public/images/customizer/bodybg/04.jpg')}}" alt=""></li>
                    <li class="main-bg-5" data-style="main-bg-5" title="Background 5"> <img src="{{asset('public/images/customizer/bodybg/05.jpg')}}" alt=""></li>
                    <li class="main-bg-6" data-style="main-bg-6" title="Background 6"> <img src="{{asset('public/images/customizer/bodybg/06.jpg')}}" alt=""></li>
                    <li class="main-bg-7" data-style="main-bg-7" title="Background 7"> <img src="{{asset('public/images/customizer/bodybg/07.jpg')}}" alt=""></li>
                    <li class="main-bg-8" data-style="main-bg-8" title="Background 8"> <img src="{{asset('public/images/customizer/bodybg/08.jpg')}}" alt=""></li>
                </ul>
                <ul class="resetAll">
